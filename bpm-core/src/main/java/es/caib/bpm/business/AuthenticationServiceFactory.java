...
public class AuthenticationServiceFactory implements ServiceFactory {
	...
	public Service openService() {
		try{
	        ...
	        String authenticationServiceClassName="es.caib.bpm.security.SeyconAuthenticationService";
	        try {
				param = EJBContainer.getBPMConfigBean().findFirstByAppKey("BPM","es.caib.bpm.authenticationServiceDelegate");
			} catch (Exception e) {}
