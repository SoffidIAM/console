...
public class AccountType
		implements java.io.Serializable
 {
	...
	/**
	 */
	public static final AccountType USER= new AccountType( new java.lang.String("U"));

	/**
	 */
	public static final AccountType SHARED= new AccountType( new java.lang.String("S"));

	/**
	 */
	public static final AccountType PRIVILEGED= new AccountType( new java.lang.String("P"));

	/**
	 */
	public static final AccountType IGNORED= new AccountType( new java.lang.String("I"));
	...
	/**
	 * Creates an instance of AccountType from <code>value</code>.
	 *
	 * @param value the value to create the AccountType from.
	 */
	public static AccountType fromString(java.lang.String value)
	{
		final AccountType typeValue = (AccountType) values.get(value);
		if (typeValue == null)
	...
	{
		return (this == that) ? 0 : this.getValue().compareTo(((AccountType)that).getValue());
	}
	...
	{
		return (this == object)
			|| (object instanceof AccountType
			    && ((AccountType)object).getValue().equals(this.getValue()));
	}
	...
	{
		return AccountType.fromString(this.value);
	}
	...
	static
	{
		...
		names.add("SHARED");
		values.put(PRIVILEGED.value, PRIVILEGED);
		literals.add(PRIVILEGED.value);
		names.add("PRIVILEGED");
		values.put(IGNORED.value, IGNORED);
		literals.add(IGNORED.value);
		names.add("IGNORED");
