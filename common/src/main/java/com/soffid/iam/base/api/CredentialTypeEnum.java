...
public class CredentialTypeEnum
		implements java.io.Serializable
 {
	...
	/**
	 */
	public static final CredentialTypeEnum CT_PASSWORD= new CredentialTypeEnum( new java.lang.String("PASS"));

	/**
	 */
	public static final CredentialTypeEnum CT_SSHKEY= new CredentialTypeEnum( new java.lang.String("SSH"));

	/**
	 */
	public static final CredentialTypeEnum CT_KUBERNETES= new CredentialTypeEnum( new java.lang.String("KUBE"));
	...
	private CredentialTypeEnum(java.lang.String value)
	{
		this.value=value;
	}

	protected CredentialTypeEnum()
	{
	}
	...
	/**
	 * Creates an instance of CredentialTypeEnum from <code>value</code>.
	 *
	 * @param value the value to create the CredentialTypeEnum from.
	 */
	public static CredentialTypeEnum fromString(java.lang.String value)
	{
		final CredentialTypeEnum typeValue = (CredentialTypeEnum) values.get(value);
		if (typeValue == null)
	...
	{
		return (this == that) ? 0 : this.getValue().compareTo(((CredentialTypeEnum)that).getValue());
	}
	...
	{
		return (this == object)
			|| (object instanceof CredentialTypeEnum
			    && ((CredentialTypeEnum)object).getValue().equals(this.getValue()));
	}
	...
	{
		return CredentialTypeEnum.fromString(this.value);
	}
	...
	static
	{
		values.put(CT_PASSWORD.value, CT_PASSWORD);
		literals.add(CT_PASSWORD.value);
		names.add("CT_PASSWORD");
		values.put(CT_SSHKEY.value, CT_SSHKEY);
		literals.add(CT_SSHKEY.value);
		names.add("CT_SSHKEY");
		values.put(CT_KUBERNETES.value, CT_KUBERNETES);
		literals.add(CT_KUBERNETES.value);
		names.add("CT_KUBERNETES");
