...
public class LetterCaseEnum
		implements java.io.Serializable
 {
	...
	/**
	 */
	public static final LetterCaseEnum UPPERCASE= new LetterCaseEnum( new java.lang.String("u"));

	/**
	 */
	public static final LetterCaseEnum LOWERCASE= new LetterCaseEnum( new java.lang.String("l"));

	/**
	 */
	public static final LetterCaseEnum MIXEDCASE= new LetterCaseEnum( new java.lang.String("m"));
	...
	private LetterCaseEnum(java.lang.String value)
	{
		this.value=value;
	}

	protected LetterCaseEnum()
	{
	}
	...
	/**
	 * Creates an instance of LetterCaseEnum from <code>value</code>.
	 *
	 * @param value the value to create the LetterCaseEnum from.
	 */
	public static LetterCaseEnum fromString(java.lang.String value)
	{
		final LetterCaseEnum typeValue = (LetterCaseEnum) values.get(value);
		if (typeValue == null)
	...
	{
		return (this == that) ? 0 : this.getValue().compareTo(((LetterCaseEnum)that).getValue());
	}
	...
	{
		return (this == object)
			|| (object instanceof LetterCaseEnum
			    && ((LetterCaseEnum)object).getValue().equals(this.getValue()));
	}
	...
	{
		return LetterCaseEnum.fromString(this.value);
	}
	...
	static
	{
		values.put(UPPERCASE.value, UPPERCASE);
		literals.add(UPPERCASE.value);
		names.add("UPPERCASE");
		values.put(LOWERCASE.value, LOWERCASE);
		literals.add(LOWERCASE.value);
		names.add("LOWERCASE");
		values.put(MIXEDCASE.value, MIXEDCASE);
		literals.add(MIXEDCASE.value);
		names.add("MIXEDCASE");
