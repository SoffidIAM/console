...
public class TasksGridRow
		...
		implements java.io.Serializable
 {
	...
	public TasksGridRow(java.util.List<java.lang.String> agents, java.util.List<com.soffid.iam.sync.api.SyncserverTask> tasks)
	{
		super();
		this.agents = agents;
		this.tasks = tasks;
	...
	public TasksGridRow(TasksGridRow otherBean)
	{
