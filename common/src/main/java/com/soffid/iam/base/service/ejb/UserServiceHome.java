...
public interface UserServiceHome
	extends jakarta.ejb.EJBLocalHome
 {
	 ...
	 */
	public static final String COMP_NAME="java:comp/ejb/UserService";

	/**
	 * The physical JDNI name
	 */
	public static final String JNDI_NAME="openejb:/local/soffid.ejb.com.soffid.iam.base.service.UserService";
