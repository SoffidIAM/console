...
public class ApplicationType
		implements java.io.Serializable
 {
	...
	/**
	 */
	public static final ApplicationType CONTAINER= new ApplicationType( new java.lang.String("container"));

	/**
	 */
	public static final ApplicationType APPLICATION= new ApplicationType( new java.lang.String("application"));

	/**
	 */
	public static final ApplicationType BUSINESS= new ApplicationType( new java.lang.String("business"));
	...
	private ApplicationType(java.lang.String value)
	{
		this.value=value;
	}
	...
	/**
	 * Creates an instance of ApplicationType from <code>value</code>.
	 *
	 * @param value the value to create the ApplicationType from.
	 */
	public static ApplicationType fromString(java.lang.String value)
	{
		final ApplicationType typeValue = (ApplicationType) values.get(value);
		if (typeValue == null)
	...
	{
		return (this == that) ? 0 : this.getValue().compareTo(((ApplicationType)that).getValue());
	}
	...
	public boolean equals(Object object)
	{
		return (this == object)
			|| (object instanceof ApplicationType
			    && ((ApplicationType)object).getValue().equals(this.getValue()));
	}
	...
	{
		return ApplicationType.fromString(this.value);
	}
	...
	static
	{
		values.put(CONTAINER.value, CONTAINER);
		literals.add(CONTAINER.value);
		names.add("CONTAINER");
		values.put(APPLICATION.value, APPLICATION);
		literals.add(APPLICATION.value);
		names.add("APPLICATION");
		values.put(BUSINESS.value, BUSINESS);
		literals.add(BUSINESS.value);
		names.add("BUSINESS");
