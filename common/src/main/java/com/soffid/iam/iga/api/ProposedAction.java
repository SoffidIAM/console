...
public class ProposedAction
		implements java.io.Serializable
 {
	...
	/**
	 */
	public static final ProposedAction LOAD= new ProposedAction( new java.lang.String("L"));

	/**
	 */
	public static final ProposedAction IGNORE= new ProposedAction( new java.lang.String("I"));
	...
	private ProposedAction(java.lang.String value)
	{
		this.value=value;
	}
	...
	/**
	 * Creates an instance of ProposedAction from <code>value</code>.
	 *
	 * @param value the value to create the ProposedAction from.
	 */
	public static ProposedAction fromString(java.lang.String value)
	{
		final ProposedAction typeValue = (ProposedAction) values.get(value);
		if (typeValue == null)
	...
	{
		return (this == that) ? 0 : this.getValue().compareTo(((ProposedAction)that).getValue());
	}
	...
	{
		return (this == object)
			|| (object instanceof ProposedAction
			    && ((ProposedAction)object).getValue().equals(this.getValue()));
	}
	...
	{
		return ProposedAction.fromString(this.value);
	}
	...
	static
	{
		values.put(LOAD.value, LOAD);
		literals.add(LOAD.value);
		names.add("LOAD");
