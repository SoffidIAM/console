...
public class HostEventAction
		implements java.io.Serializable
 {
	...
	/**
	 */
	public static final HostEventAction LOCK= new HostEventAction( new java.lang.String("L"));

	/**
	 */
	public static final HostEventAction UNLOCK= new HostEventAction( new java.lang.String("U"));
	...
	private HostEventAction(java.lang.String value)
	{
		this.value=value;
	}

	protected HostEventAction()
	{
	}
	...
	/**
	 * Creates an instance of HostEventAction from <code>value</code>.
	 *
	 * @param value the value to create the HostEventAction from.
	 */
	public static HostEventAction fromString(java.lang.String value)
	{
		final HostEventAction typeValue = (HostEventAction) values.get(value);
		if (typeValue == null)
	...
	{
		return (this == that) ? 0 : this.getValue().compareTo(((HostEventAction)that).getValue());
	}
	...
	{
		return (this == object)
			|| (object instanceof HostEventAction
			    && ((HostEventAction)object).getValue().equals(this.getValue()));
	}
	...
	{
		return HostEventAction.fromString(this.value);
	}
