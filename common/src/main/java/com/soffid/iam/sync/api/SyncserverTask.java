...
public class SyncserverTask implements Serializable, Comparable {
	...
	public SyncserverTask(Long id, String descripcioTasca) {
		this.id = id;
		this.descripcioTasca = descripcioTasca;
	}

	public SyncserverTask(Long id, String descripcioTasca, String[] estatExecucioAgents) {
		this.id = id;
		this.descripcioTasca = descripcioTasca;
	...
	public int compareTo(Object o) {
		if (o instanceof SyncserverTask && getTaskName() != null)
			return getTaskName().compareTo(
					((SyncserverTask) o).getTaskName());
		return 0;
	}
