 ...
 * <br>thread timeout: cancelará el proceso si transcurrido el tiempo máximo de
 * ejecución, éste no ha finalizado<br>
 * <br>consumidor de salida estándar: lee la salida estándar del proceso y la
 * almacena en memoria<br>
 * <br>consumidor de error estándra: lee el error estándar del proceso y lo 
 * almacena en memoria<br>
 * <br>proceso de sistema operativo: ejecuta el proceso indicado en el método 
 * exec (sincrónamente) o execNoWait (asíncronamente)<br>
