...
public class DatosGenericos  implements java.io.Serializable {
    private es.map.www.scsp.esquemas.V2.peticion.Emisor emisor;

    private es.map.www.scsp.esquemas.V2.peticion.Solicitante solicitante;

    private es.map.www.scsp.esquemas.V2.peticion.Titular titular;

    private es.map.www.scsp.esquemas.V2.peticion.Transmision transmision;

    public DatosGenericos() {
    }

    public DatosGenericos(
           es.map.www.scsp.esquemas.V2.peticion.Emisor emisor,
           es.map.www.scsp.esquemas.V2.peticion.Solicitante solicitante,
           es.map.www.scsp.esquemas.V2.peticion.Titular titular,
           es.map.www.scsp.esquemas.V2.peticion.Transmision transmision) {
           this.emisor = emisor;
     ...
     * @return emisor
     */
    public es.map.www.scsp.esquemas.V2.peticion.Emisor getEmisor() {
        return emisor;
    }
     ...
     * @param emisor
     */
    public void setEmisor(es.map.www.scsp.esquemas.V2.peticion.Emisor emisor) {
        this.emisor = emisor;
    }
     ...
     * @return solicitante
     */
    public es.map.www.scsp.esquemas.V2.peticion.Solicitante getSolicitante() {
        return solicitante;
    }
     ...
     * @param solicitante
     */
    public void setSolicitante(es.map.www.scsp.esquemas.V2.peticion.Solicitante solicitante) {
        this.solicitante = solicitante;
    }
     ...
     * @return titular
     */
    public es.map.www.scsp.esquemas.V2.peticion.Titular getTitular() {
        return titular;
    }
     ...
     * @param titular
     */
    public void setTitular(es.map.www.scsp.esquemas.V2.peticion.Titular titular) {
        this.titular = titular;
    }
     ...
     * @return transmision
     */
    public es.map.www.scsp.esquemas.V2.peticion.Transmision getTransmision() {
        return transmision;
    }
     ...
     * @param transmision
     */
    public void setTransmision(es.map.www.scsp.esquemas.V2.peticion.Transmision transmision) {
        this.transmision = transmision;
    }
