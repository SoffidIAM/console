...
public class SolicitudTransmision  implements java.io.Serializable {
    private es.map.www.scsp.esquemas.V2.peticion.DatosGenericos datosGenericos;
    ...
    public SolicitudTransmision(
           es.map.www.scsp.esquemas.V2.peticion.DatosGenericos datosGenericos,
     ...
     */
    public es.map.www.scsp.esquemas.V2.peticion.DatosGenericos getDatosGenericos() {
        return datosGenericos;
    }
     ...
     */
    public void setDatosGenericos(es.map.www.scsp.esquemas.V2.peticion.DatosGenericos datosGenericos) {
        this.datosGenericos = datosGenericos;
    }
