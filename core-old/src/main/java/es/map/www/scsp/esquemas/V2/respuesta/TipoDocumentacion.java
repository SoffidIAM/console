...
public class TipoDocumentacion implements java.io.Serializable {
    ...
    public static final java.lang.String _CIF = "CIF"; //$NON-NLS-1$
    public static final java.lang.String _NIF = "NIF"; //$NON-NLS-1$
    public static final java.lang.String _DNI = "DNI"; //$NON-NLS-1$
    public static final java.lang.String _Pasaporte = "Pasaporte"; //$NON-NLS-1$
    public static final java.lang.String _NIE = "NIE"; //$NON-NLS-1$
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/V2/respuesta", ">TipoDocumentacion")); //$NON-NLS-1$ //$NON-NLS-2$
    }
    /**
