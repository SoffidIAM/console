...
public class Titular  implements java.io.Serializable {
    private es.map.www.scsp.esquemas.V2.respuesta.TipoDocumentacion tipoDocumentacion;
    ...
    public Titular(
           es.map.www.scsp.esquemas.V2.respuesta.TipoDocumentacion tipoDocumentacion,
     ...
     */
    public es.map.www.scsp.esquemas.V2.respuesta.TipoDocumentacion getTipoDocumentacion() {
        return tipoDocumentacion;
    }
     ...
     */
    public void setTipoDocumentacion(es.map.www.scsp.esquemas.V2.respuesta.TipoDocumentacion tipoDocumentacion) {
        this.tipoDocumentacion = tipoDocumentacion;
    }
