...
public class SolicitudTransmision  implements java.io.Serializable {
    private es.map2.www.scsp.esquemas.V2.peticion.DatosGenericos datosGenericos;

    private es.map2.www.scsp.esquemas.datosespecificos.DatosEspecificos datosEspecificos;

    public SolicitudTransmision() {
    }

    public SolicitudTransmision(
           es.map2.www.scsp.esquemas.V2.peticion.DatosGenericos datosGenericos,
           es.map2.www.scsp.esquemas.datosespecificos.DatosEspecificos datosEspecificos) {
     ...
     */
    public es.map2.www.scsp.esquemas.V2.peticion.DatosGenericos getDatosGenericos() {
        return datosGenericos;
    }
     ...
     */
    public void setDatosGenericos(es.map2.www.scsp.esquemas.V2.peticion.DatosGenericos datosGenericos) {
        this.datosGenericos = datosGenericos;
    }
     ...
     */
    public es.map2.www.scsp.esquemas.datosespecificos.DatosEspecificos getDatosEspecificos() {
        return datosEspecificos;
    }
     ...
     */
    public void setDatosEspecificos(es.map2.www.scsp.esquemas.datosespecificos.DatosEspecificos datosEspecificos) {
        this.datosEspecificos = datosEspecificos;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/V2/peticion", ">SolicitudTransmision")); //$NON-NLS-1$ //$NON-NLS-2$
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("datosGenericos"); //$NON-NLS-1$
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/V2/peticion", "DatosGenericos")); //$NON-NLS-1$ //$NON-NLS-2$
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/V2/peticion", ">DatosGenericos")); //$NON-NLS-1$ //$NON-NLS-2$
