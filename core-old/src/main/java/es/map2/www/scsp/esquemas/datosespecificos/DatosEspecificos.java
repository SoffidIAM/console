...
public class DatosEspecificos  implements java.io.Serializable {
    private es.map2.www.scsp.esquemas.datosespecificos.SolicitanteDatos solicitanteDatos;

    private es.map2.www.scsp.esquemas.datosespecificos.Solicitud solicitud;

    private es.map2.www.scsp.esquemas.datosespecificos.EstadoResultado estadoResultado;

    private es.map2.www.scsp.esquemas.datosespecificos.DatosTitular datosTitular;

    public DatosEspecificos() {
    }

    public DatosEspecificos(
           es.map2.www.scsp.esquemas.datosespecificos.SolicitanteDatos solicitanteDatos,
           es.map2.www.scsp.esquemas.datosespecificos.Solicitud solicitud,
           es.map2.www.scsp.esquemas.datosespecificos.EstadoResultado estadoResultado,
           es.map2.www.scsp.esquemas.datosespecificos.DatosTitular datosTitular) {
     ...
     */
    public es.map2.www.scsp.esquemas.datosespecificos.SolicitanteDatos getSolicitanteDatos() {
        return solicitanteDatos;
    }
     ...
     */
    public void setSolicitanteDatos(es.map2.www.scsp.esquemas.datosespecificos.SolicitanteDatos solicitanteDatos) {
        this.solicitanteDatos = solicitanteDatos;
    }
     ...
     * @return solicitud
     */
    public es.map2.www.scsp.esquemas.datosespecificos.Solicitud getSolicitud() {
        return solicitud;
    }
     ...
     * @param solicitud
     */
    public void setSolicitud(es.map2.www.scsp.esquemas.datosespecificos.Solicitud solicitud) {
        this.solicitud = solicitud;
    }
     ...
     */
    public es.map2.www.scsp.esquemas.datosespecificos.EstadoResultado getEstadoResultado() {
        return estadoResultado;
    }
     ...
     */
    public void setEstadoResultado(es.map2.www.scsp.esquemas.datosespecificos.EstadoResultado estadoResultado) {
        this.estadoResultado = estadoResultado;
    }
     ...
     * @return datosTitular
     */
    public es.map2.www.scsp.esquemas.datosespecificos.DatosTitular getDatosTitular() {
        return datosTitular;
    }
     ...
     * @param datosTitular
     */
    public void setDatosTitular(es.map2.www.scsp.esquemas.datosespecificos.DatosTitular datosTitular) {
        this.datosTitular = datosTitular;
    }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("datosTitular"); //$NON-NLS-1$
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", "DatosTitular")); //$NON-NLS-1$ //$NON-NLS-2$
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">DatosTitular")); //$NON-NLS-1$ //$NON-NLS-2$
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
