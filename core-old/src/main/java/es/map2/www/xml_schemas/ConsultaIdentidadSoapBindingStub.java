/**
 * ConsultaIdentidadSoapBindingStub.java
 *
...
public class ConsultaIdentidadSoapBindingStub extends org.apache.axis.client.Stub implements es.map2.www.xml_schemas.PeticionPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("consultarIdentidad"); //$NON-NLS-1$
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/V2/peticion", "Peticion"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/V2/peticion", ">Peticion"), es.map2.www.scsp.esquemas.V2.peticion.Peticion.class, false, false); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ...
        oper.setReturnClass(es.map2.www.scsp.esquemas.V2.respuesta.Respuesta.class);
    ...
    public ConsultaIdentidadSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ConsultaIdentidadSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ConsultaIdentidadSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings0() {
            ...
            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">DatosTitular"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.DatosTitular.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">DatosVia"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.EstadoResultado.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">FechaCaducidad"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">Identificador"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">Localidad"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">Nacionalidad"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">NomMadre"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">NomPadre"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = java.lang.String.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(org.apache.axis.encoding.ser.BaseSerializerFactory.createFactory(org.apache.axis.encoding.ser.SimpleSerializerFactory.class, cls, qName));
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.Organizacion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.Sexo.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.SolicitanteDatos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.Solicitud.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">Tipo"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.Tipo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", "DatosDireccionType"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.DatosDireccionType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.DatosEspecificos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", "DatosNacimientoType"); //$NON-NLS-1$ //$NON-NLS-2$
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.datosespecificos.DatosNacimientoType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.Atributos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.Consentimiento.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.DatosGenericos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.Emisor.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.Estado.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.Funcionario.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.Peticion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.Solicitante.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.SolicitudTransmision[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.TipoDocumentacion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.Titular.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.peticion.Transmision.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.Atributos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.Consentimiento.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.DatosGenericos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.Emisor.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.Estado.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.Funcionario.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.Respuesta.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.Solicitante.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.TipoDocumentacion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.Titular.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings1() {
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.Transmision.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.map2.www.scsp.esquemas.V2.respuesta.TransmisionDatos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    protected org.apache.axis.client.Call createCall() throws java.rmi.RemoteException {
        try {
            ...
            throw new org.apache.axis.AxisFault(Messages.getString("ConsultaIdentidadSoapBindingStub.CallObjectFailure"), _t); //$NON-NLS-1$
        }
    }

    public es.map2.www.scsp.esquemas.V2.respuesta.Respuesta consultarIdentidad(es.map2.www.scsp.esquemas.V2.peticion.Peticion peticion) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("", "consultarIdentidad")); //$NON-NLS-1$ //$NON-NLS-2$
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {peticion});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (es.map2.www.scsp.esquemas.V2.respuesta.Respuesta) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.map2.www.scsp.esquemas.V2.respuesta.Respuesta) org.apache.axis.utils.JavaUtils.convert(_resp, es.map2.www.scsp.esquemas.V2.respuesta.Respuesta.class);
            }
        }
