 ...
 * 
 */
public final class NetworkTypeEnum
	extends NetworkType
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((NetworkType)object).getValue());
	}
	...
	{
		return NetworkType.fromString(java.lang.String.valueOf(string));
	}
}
