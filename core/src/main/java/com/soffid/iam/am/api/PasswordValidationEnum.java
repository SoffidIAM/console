 ...
 * 
 */
public final class PasswordValidationEnum
	extends PasswordValidation
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((PasswordValidation)object).getValue());
	}
	...
	{
		return PasswordValidation.fromString(java.lang.String.valueOf(string));
	}
}
