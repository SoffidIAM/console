 ...
 * 
 */
public final class SessionTypeEnum
	extends SessionType
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((SessionType)object).getValue());
	}
	...
	{
		return SessionType.fromString(java.lang.String.valueOf(string));
	}
}
