 ...
 */
public abstract class EntryPointGroupEntityDaoBase
	extends org.springframework.orm.hibernate3.support.HibernateDaoSupport
	implements com.soffid.iam.am.model.EntryPointGroupEntityDao
{
	 ...
	 */
	public java.util.List<com.soffid.iam.am.api.AccessTreeAuthorization> toAccessTreeAuthorizationList (java.util.Collection<com.soffid.iam.am.model.EntryPointGroupEntity> instances) {
		if (instances == null)
			return null;
		else {
			...
			for (final com.soffid.iam.am.model.EntryPointGroupEntity instance: instances)
			{
	...
	public void accessTreeAuthorizationToEntity (com.soffid.iam.am.api.AccessTreeAuthorization source, com.soffid.iam.am.model.EntryPointGroupEntity target, boolean copyIfNull) {
		// Attributes for EntryPointGroupEntity
		// Missing attribute auhtorizationLevel on entity
	...
	public com.soffid.iam.am.model.EntryPointGroupEntity accessTreeAuthorizationToEntity (com.soffid.iam.am.api.AccessTreeAuthorization instance) {
		com.soffid.iam.am.model.EntryPointGroupEntity entity = null;
		if (instance.getId() != null) 
			entity = load(instance.getId());
		if (entity == null)
			entity = newEntryPointGroupEntity();
	...
	public java.util.List<com.soffid.iam.am.model.EntryPointGroupEntity>  accessTreeAuthorizationToEntityList (java.util.Collection<com.soffid.iam.am.api.AccessTreeAuthorization> instances) 
	{
		if (instances == null)
			return null;
		java.util.LinkedList<com.soffid.iam.am.model.EntryPointGroupEntity> list =
			new java.util.LinkedList<com.soffid.iam.am.model.EntryPointGroupEntity>();
	...
	{
		return new com.soffid.iam.am.model.EntryPointGroupEntityImpl();
	}
	...
	public com.soffid.iam.am.model.EntryPointGroupEntity load(java.lang.Long id) {
		...
		com.soffid.iam.am.model.EntryPointGroupEntity result = (com.soffid.iam.am.model.EntryPointGroupEntity) this.getHibernateTemplate().get(com.soffid.iam.am.model.EntryPointGroupEntityImpl.class, id);
	...
	public java.util.List<com.soffid.iam.am.model.EntryPointGroupEntity> loadAll() {
		java.util.List<com.soffid.iam.am.model.EntryPointGroupEntity> result = (java.util.List<com.soffid.iam.am.model.EntryPointGroupEntity>)
			this.getHibernateTemplate().loadAll(com.soffid.iam.am.model.EntryPointGroupEntity.class);
		return result;
	};
	...
	public void create (com.soffid.iam.am.model.EntryPointGroupEntity entity)
	{
		if (entity == null)
		{
			throw new IllegalArgumentException(
				"EntryPointGroupEntityDao.create - 'entity' can not be null");
		}
	...
	public void update (com.soffid.iam.am.model.EntryPointGroupEntity entity)
	{
		...
		{
			throw new IllegalArgumentException(
				"EntryPointGroupEntityDao.update - 'entity' can not be null");
		}
	...
	public void remove (com.soffid.iam.am.model.EntryPointGroupEntity entity)
	{
		...
		{
			throw new IllegalArgumentException(
				"EntryPointGroupEntityDao.remove - 'entity' can not be null");
		}
	...
	public void create (java.util.Collection<? extends com.soffid.iam.am.model.EntryPointGroupEntity> entities) {
		...
		{
			throw new IllegalArgumentException(
				"EntryPointGroupEntityDao.create - 'entities' cannot be null");
		}
		for (com.soffid.iam.am.model.EntryPointGroupEntity entity: entities) { 
			create(entity);
		}
	}
	...
	public void update (java.util.Collection<? extends com.soffid.iam.am.model.EntryPointGroupEntity> entities) {
		...
		{
			throw new IllegalArgumentException(
				"EntryPointGroupEntityDao.update - 'entities' cannot be null");
		}
		for (com.soffid.iam.am.model.EntryPointGroupEntity entity: entities) { 
			update(entity);
		}
	...
	public void remove (java.util.Collection<? extends com.soffid.iam.am.model.EntryPointGroupEntity> entities) {
		...
		{
			throw new IllegalArgumentException(
				"EntryPointGroupEntityDao.remove - 'entities' cannot be null");
		}
		for (com.soffid.iam.am.model.EntryPointGroupEntity entity: entities) { 
			remove(entity);
		}
	...
	public void remove (java.lang.Long id)
	{
		...
		{
			throw new IllegalArgumentException(
				"EntryPointGroupEntityDao.remove - 'id' can not be null");
		}
		com.soffid.iam.am.model.EntryPointGroupEntity entity = this.load(id);
		if (entity != null)
			this.remove(entity);
	}
	 ...
	 */
	public java.util.List<com.soffid.iam.am.model.EntryPointGroupEntity> query (String queryString, com.soffid.iam.model.Parameter[] parameters)
	{
		try {
			java.util.List results = new com.soffid.iam.model.QueryBuilder().query(this,
				queryString, parameters);
			return (java.util.List<com.soffid.iam.am.model.EntryPointGroupEntity>) results;
	 ...
	 */
	public java.util.List<com.soffid.iam.am.model.EntryPointGroupEntity> query (String queryString, com.soffid.iam.model.Parameter[] parameters, com.soffid.iam.model.criteria.CriteriaSearchConfiguration criteria)
	{
		try {
			java.util.List results = new com.soffid.iam.model.QueryBuilder().query(this,
