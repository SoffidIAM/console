...
/**
 * @see <code>com.soffid.iam.am.service.SessionService</code>,
 * @see <code>com.soffid.iam.am.service.SessionService</code>,
 */
@jakarta.ejb.Stateless(name="SessionService", mappedName="openejb:/local/soffid.ejb.com.soffid.iam.am.service.SessionService")
@jakarta.ejb.Local(com.soffid.iam.am.service.ejb.SessionService.class)
...
public class SessionServiceBean extends org.springframework.ejb.support.AbstractStatelessSessionBean
  implements com.soffid.iam.am.service.ejb.SessionService
{
	private com.soffid.iam.am.service.SessionService sessionService;

	/**
	 * @see com.soffid.iam.am.service.SessionService#java.util.Collection<com.soffid.iam.am.api.Session> findActiveSessions()
	 */
		...
		throws com.soffid.iam.exception.InternalErrorException, com.soffid.iam.exception.InternalErrorException
	{
		...
		if (! com.soffid.iam.utils.Security.isUserInRole("user:session:query"))
			throw new SecurityException("Unable to execute SessionService.findActiveSessions. Required roles: [user:session:query]");
		try
		{
	...
	protected void onEjbCreate()
	{
		...
		this.sessionService = (com.soffid.iam.am.service.SessionService)
		getBeanFactory().getBean("com.soffid.iam.am.service.SessionService");
	}
