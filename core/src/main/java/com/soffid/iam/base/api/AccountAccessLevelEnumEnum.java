 ...
 * 
 */
public final class AccountAccessLevelEnumEnum
	extends AccountAccessLevelEnum
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	 ...
	 */
	public AccountAccessLevelEnumEnum()
	{
		super();
	}
	...
	{
		return AccountAccessLevelEnum.class;
	}
	...
	{
		return java.lang.String.valueOf(((AccountAccessLevelEnum)object).getValue());
	}
	...
	{
		return AccountAccessLevelEnum.fromString(java.lang.String.valueOf(string));
	}
}
