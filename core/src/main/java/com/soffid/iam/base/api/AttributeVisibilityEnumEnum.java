...
public final class AttributeVisibilityEnumEnum
	extends AttributeVisibilityEnum
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	 ...
	 */
	public AttributeVisibilityEnumEnum()
	{
		super();
	}
	...
	{
		return AttributeVisibilityEnum.class;
	}
	...
	{
		return java.lang.String.valueOf(((AttributeVisibilityEnum)object).getValue());
	}
	...
	{
		return AttributeVisibilityEnum.fromString(java.lang.String.valueOf(string));
	}
}
