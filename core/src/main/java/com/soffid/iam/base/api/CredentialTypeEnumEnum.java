 ...
 * 
 */
public final class CredentialTypeEnumEnum
	extends CredentialTypeEnum
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return CredentialTypeEnum.class;
	}
	...
	{
		return java.lang.String.valueOf(((CredentialTypeEnum)object).getValue());
	}
	...
	{
		return CredentialTypeEnum.fromString(java.lang.String.valueOf(string));
	}
}
