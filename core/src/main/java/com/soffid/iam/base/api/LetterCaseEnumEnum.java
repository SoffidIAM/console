 ...
 * 
 */
public final class LetterCaseEnumEnum
	extends LetterCaseEnum
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((LetterCaseEnum)object).getValue());
	}
	...
	{
		return LetterCaseEnum.fromString(java.lang.String.valueOf(string));
	}
}
