 ...
 * 
 */
public final class MetadataScopeEnum
	extends MetadataScope
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((MetadataScope)object).getValue());
	}
	...
	{
		return MetadataScope.fromString(java.lang.String.valueOf(string));
	}
}
