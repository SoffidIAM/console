 ...
 * 
 */
public final class ServerPluginModuleTypeEnum
	extends ServerPluginModuleType
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	 ...
	 */
	public ServerPluginModuleTypeEnum()
	{
		super();
	}
	...
	{
		return ServerPluginModuleType.class;
	}
	...
	{
		return java.lang.String.valueOf(((ServerPluginModuleType)object).getValue());
	}
	...
	{
		return ServerPluginModuleType.fromString(java.lang.String.valueOf(string));
	}
}
