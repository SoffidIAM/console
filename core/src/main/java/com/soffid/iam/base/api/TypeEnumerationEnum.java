 ...
 * 
 */
public final class TypeEnumerationEnum
	extends TypeEnumeration
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((TypeEnumeration)object).getValue());
	}
	...
	{
		return TypeEnumeration.fromString(java.lang.String.valueOf(string));
	}
}
