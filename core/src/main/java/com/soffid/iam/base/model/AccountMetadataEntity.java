...
public abstract class AccountMetadataEntity {
	 ...
	 * Attribute data
	 */
	private java.util.Collection<com.soffid.iam.base.model.AccountAttributeEntity> data =  new java.util.HashSet<com.soffid.iam.base.model.AccountAttributeEntity>();
	/**
	 * Gets value for attribute data
	 */
	public java.util.Collection<com.soffid.iam.base.model.AccountAttributeEntity> getData() {
		return this.data;
	}
	/**
	 * Sets value for attribute data
	 */
	public void setData(java.util.Collection<com.soffid.iam.base.model.AccountAttributeEntity> data) {
		this.data = data;
	}
	/**
	 * Attribute type
	 ...
	 * Expression to test if the reference object can be selected 
	 */
	...
	/**
	 * Returns <code>true</code> if the argument is an AccountMetadataEntity instance and all identifiers for this entity 
	...
	public boolean equals(Object object)
	{
		...
		if (!(object instanceof AccountMetadataEntity))
		{
			return false;
		}
		final AccountMetadataEntity that = (AccountMetadataEntity)object;
