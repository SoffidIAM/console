 ...
 * @see com.soffid.iam.base.model.TenantDisabledPermissionEntity
 */
public interface TenantDisabledPermissionEntityDao

{
	 ...
	 */
	public java.util.List<com.soffid.iam.base.model.TenantDisabledPermissionEntity> query (String query, com.soffid.iam.model.Parameter[] parameters);
	 ...
	 */
	public java.util.List<com.soffid.iam.base.model.TenantDisabledPermissionEntity> query (String query, com.soffid.iam.model.Parameter[] parameters, com.soffid.iam.model.criteria.CriteriaSearchConfiguration criteria);
