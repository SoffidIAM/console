...
/**
 * @see <code>com.soffid.iam.base.service.GenAIProviderService</code>,
 * @see <code>com.soffid.iam.base.service.GenAIProviderService</code>,
 */
@jakarta.ejb.Stateless(name="GenAIProviderService", mappedName="openejb:/local/soffid.ejb.com.soffid.iam.base.service.GenAIProviderService")
@jakarta.ejb.Local(com.soffid.iam.base.service.ejb.GenAIProviderService.class)
...
public class GenAIProviderServiceBean extends org.springframework.ejb.support.AbstractStatelessSessionBean
  implements com.soffid.iam.base.service.ejb.GenAIProviderService
{
	private com.soffid.iam.base.service.GenAIProviderService genAIProviderService;

	/**
	 * @see com.soffid.iam.base.service.GenAIProviderService#java.util.List<java.lang.String> getGenAIMetadata(java.lang.String engine)
	 */
		...
		throws com.soffid.iam.exception.InternalErrorException
	{
		...
		try
		{
			return this.genAIProviderService.getGenAIMetadata(engine); 
		}
	...
	/**
	 * @see com.soffid.iam.base.service.GenAIProviderService#java.util.List<java.lang.String> getGenAISentences(java.lang.String engine, java.lang.String[] context, java.lang.String sentence)
	 */
	@jakarta.annotation.security.PermitAll
		...
		throws com.soffid.iam.exception.InternalErrorException
	{
		...
		try
		{
			return this.genAIProviderService.getGenAISentences(engine, context, sentence); 
		}
		catch (Exception exception)
		{
			final Throwable cause = getRootCause(exception);
	...
	/**
	 * @see com.soffid.iam.base.service.GenAIProviderService#void clearCache()
	 */
	@jakarta.annotation.security.PermitAll
		...
		throws com.soffid.iam.exception.InternalErrorException
	{
		...
		try
		{
			this.genAIProviderService.clearCache(); 
		}
		catch (Exception exception)
		{
			final Throwable cause = getRootCause(exception);
	...
	protected void onEjbCreate()
	{
		...
		this.genAIProviderService = (com.soffid.iam.base.service.GenAIProviderService)
		getBeanFactory().getBean("com.soffid.iam.base.service.GenAIProviderService");
	}
