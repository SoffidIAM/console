...
/**
 * @see <code>com.soffid.iam.base.service.StatsService</code>,
 * @see <code>com.soffid.iam.base.service.StatsService</code>,
 */
@jakarta.ejb.Stateless(name="StatsService", mappedName="openejb:/local/soffid.ejb.com.soffid.iam.base.service.StatsService")
@jakarta.ejb.Local(com.soffid.iam.base.service.ejb.StatsService.class)
...
public class StatsServiceBean extends org.springframework.ejb.support.AbstractStatelessSessionBean
  implements com.soffid.iam.base.service.ejb.StatsService
{
	private com.soffid.iam.base.service.StatsService statsService;

	/**
	 * @see com.soffid.iam.base.service.StatsService#com.soffid.iam.base.api.Stats findStats(java.lang.String name, java.util.Date since, java.util.Date until, int step)
	 */
		...
		throws com.soffid.iam.exception.InternalErrorException
	{
		...
		try
		{
			return this.statsService.findStats(name, since, until, step); 
		}
	...
	protected void onEjbCreate()
	{
		...
		this.statsService = (com.soffid.iam.base.service.StatsService)
		getBeanFactory().getBean("com.soffid.iam.base.service.StatsService");
	}
