 ...
 * 
 */
public final class PredefinedProcessTypeEnum
	extends PredefinedProcessType
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	 ...
	 */
	public PredefinedProcessTypeEnum()
	{
		super();
	}
	...
	{
		return PredefinedProcessType.class;
	}
	...
	{
		return java.lang.String.valueOf(((PredefinedProcessType)object).getValue());
	}
	...
	{
		return PredefinedProcessType.fromString(java.lang.String.valueOf(string));
	}
}
