...
/**
 * @see <code>com.soffid.iam.bpm.service.BpmConfigService</code>,
 * @see <code>com.soffid.iam.bpm.service.BpmConfigService</code>,
 */
@jakarta.ejb.Stateless(name="BpmConfigService", mappedName="openejb:/local/soffid.ejb.com.soffid.iam.bpm.service.BpmConfigService")
@jakarta.ejb.Local(com.soffid.iam.bpm.service.ejb.BpmConfigService.class)
...
public class BpmConfigServiceBean extends org.springframework.ejb.support.AbstractStatelessSessionBean
  implements com.soffid.iam.bpm.service.ejb.BpmConfigService
{
	...
	protected void onEjbCreate()
	{
		...
		this.bpmConfigService = (com.soffid.iam.bpm.service.BpmConfigService)
		getBeanFactory().getBean("com.soffid.iam.bpm.service.BpmConfigService");
	}
