 ...
 * 
 */
public final class AccountProposedActionEnum
	extends AccountProposedAction
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	 ...
	 */
	public AccountProposedActionEnum()
	{
		super();
	}
	...
	{
		return AccountProposedAction.class;
	}
	...
	{
		return java.lang.String.valueOf(((AccountProposedAction)object).getValue());
	}
	...
	{
		return AccountProposedAction.fromString(java.lang.String.valueOf(string));
	}
}
