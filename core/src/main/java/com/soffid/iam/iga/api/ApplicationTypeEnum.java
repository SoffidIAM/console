 ...
 * 
 */
public final class ApplicationTypeEnum
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((ApplicationType)object).getValue());
	}
	...
	{
		return ApplicationType.fromString(java.lang.String.valueOf(string));
	}
}
