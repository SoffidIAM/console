 ...
 * 
 */
public final class AttributeDirectionEnum
	extends AttributeDirection
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return AttributeDirection.class;
	}
	...
	{
		return java.lang.String.valueOf(((AttributeDirection)object).getValue());
	}
	...
	{
		return AttributeDirection.fromString(java.lang.String.valueOf(string));
	}
}
