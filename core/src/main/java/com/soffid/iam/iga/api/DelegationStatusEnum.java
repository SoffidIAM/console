 ...
 * 
 */
public final class DelegationStatusEnum
	extends DelegationStatus
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((DelegationStatus)object).getValue());
	}
	...
	{
		return DelegationStatus.fromString(java.lang.String.valueOf(string));
	}
}
