 ...
 * 
 */
public final class EventUserActionEnum
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((EventUserAction)object).getValue());
	}
	...
	{
		return EventUserAction.fromString(java.lang.String.valueOf(string));
	}
}
