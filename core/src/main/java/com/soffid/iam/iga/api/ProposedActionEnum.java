 ...
 * 
 */
public final class ProposedActionEnum
	extends ProposedAction
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((ProposedAction)object).getValue());
	}
	...
	{
		return ProposedAction.fromString(java.lang.String.valueOf(string));
	}
}
