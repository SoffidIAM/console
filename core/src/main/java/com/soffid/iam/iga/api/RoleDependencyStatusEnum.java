 ...
 * 
 */
public final class RoleDependencyStatusEnum
	extends RoleDependencyStatus
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	 ...
	 */
	public RoleDependencyStatusEnum()
	{
		super();
	}
	...
	{
		return RoleDependencyStatus.class;
	}
	...
	{
		return java.lang.String.valueOf(((RoleDependencyStatus)object).getValue());
	}
	...
	{
		return RoleDependencyStatus.fromString(java.lang.String.valueOf(string));
	}
}
