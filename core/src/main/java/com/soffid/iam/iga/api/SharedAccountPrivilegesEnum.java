 ...
 * 
 */
public final class SharedAccountPrivilegesEnum
	extends SharedAccountPrivileges
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	 ...
	 */
	public SharedAccountPrivilegesEnum()
	{
		super();
	}
	...
	{
		return SharedAccountPrivileges.class;
	}
	...
	{
		return java.lang.String.valueOf(((SharedAccountPrivileges)object).getValue());
	}
	...
	{
		return SharedAccountPrivileges.fromString(java.lang.String.valueOf(string));
	}
}
