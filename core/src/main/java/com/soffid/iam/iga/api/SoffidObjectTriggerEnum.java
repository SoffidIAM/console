 ...
 * 
 */
public final class SoffidObjectTriggerEnum
	extends SoffidObjectTrigger
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	 ...
	 */
	public SoffidObjectTriggerEnum()
	{
		super();
	}
	...
	{
		return SoffidObjectTrigger.class;
	}
	...
	{
		return java.lang.String.valueOf(((SoffidObjectTrigger)object).getValue());
	}
	...
	{
		return SoffidObjectTrigger.fromString(java.lang.String.valueOf(string));
	}
}
