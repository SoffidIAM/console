 ...
 * 
 */
public final class SoffidObjectTypeEnum
	extends SoffidObjectType
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((SoffidObjectType)object).getValue());
	}
	...
	{
		return SoffidObjectType.fromString(java.lang.String.valueOf(string));
	}
}
