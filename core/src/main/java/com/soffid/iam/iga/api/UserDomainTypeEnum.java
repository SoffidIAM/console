 ...
 * 
 */
public final class UserDomainTypeEnum
	extends UserDomainType
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((UserDomainType)object).getValue());
	}
	...
	{
		return UserDomainType.fromString(java.lang.String.valueOf(string));
	}
}
