 ...
 */
public abstract class GroupAttributeEntityDaoBase
	extends org.springframework.orm.hibernate3.support.HibernateDaoSupport
	implements com.soffid.iam.iga.model.GroupAttributeEntityDao
{
	...
	**/
	...
	{
		return findByNameAndValue("select att from com.soffid.iam.iga.model.GroupAttributeEntity as att where att.metadata.name = :name and att.value = :value ",
			criteria, name, value);
	}
	/**
	 * Internal implementation
	 */
	public java.util.List<com.soffid.iam.iga.model.GroupAttributeEntity> findByNameAndValue(final java.lang.String queryString, com.soffid.iam.model.criteria.CriteriaSearchConfiguration criteria, java.lang.String name, java.lang.String value)
	
	{
		try
		{
			...
			return (java.util.List<com.soffid.iam.iga.model.GroupAttributeEntity>) results;
		}
	...
	{
		return new com.soffid.iam.iga.model.GroupAttributeEntityImpl();
	}
	...
	public com.soffid.iam.iga.model.GroupAttributeEntity load(java.lang.Long id) {
		...
		com.soffid.iam.iga.model.GroupAttributeEntity result = (com.soffid.iam.iga.model.GroupAttributeEntity) this.getHibernateTemplate().get(com.soffid.iam.iga.model.GroupAttributeEntityImpl.class, id);
	...
	public java.util.List<com.soffid.iam.iga.model.GroupAttributeEntity> loadAll() {
		java.util.List<com.soffid.iam.iga.model.GroupAttributeEntity> result = (java.util.List<com.soffid.iam.iga.model.GroupAttributeEntity>)
			this.getHibernateTemplate().loadAll(com.soffid.iam.iga.model.GroupAttributeEntity.class);
		return result;
	};
	...
	public void create (com.soffid.iam.iga.model.GroupAttributeEntity entity)
	{
		if (entity == null)
		{
			throw new IllegalArgumentException(
				"GroupAttributeEntityDao.create - 'entity' can not be null");
		}
	...
	public void update (com.soffid.iam.iga.model.GroupAttributeEntity entity)
	{
		...
		{
			throw new IllegalArgumentException(
				"GroupAttributeEntityDao.update - 'entity' can not be null");
		}
	...
	public void remove (com.soffid.iam.iga.model.GroupAttributeEntity entity)
	{
		...
		{
			throw new IllegalArgumentException(
				"GroupAttributeEntityDao.remove - 'entity' can not be null");
		}
	...
	public void create (java.util.Collection<? extends com.soffid.iam.iga.model.GroupAttributeEntity> entities) {
		...
		{
			throw new IllegalArgumentException(
				"GroupAttributeEntityDao.create - 'entities' cannot be null");
		}
		for (com.soffid.iam.iga.model.GroupAttributeEntity entity: entities) { 
			create(entity);
		}
	}
	...
	public void update (java.util.Collection<? extends com.soffid.iam.iga.model.GroupAttributeEntity> entities) {
		...
		{
			throw new IllegalArgumentException(
				"GroupAttributeEntityDao.update - 'entities' cannot be null");
		}
		for (com.soffid.iam.iga.model.GroupAttributeEntity entity: entities) { 
			update(entity);
		}
	...
	public void remove (java.util.Collection<? extends com.soffid.iam.iga.model.GroupAttributeEntity> entities) {
		...
		{
			throw new IllegalArgumentException(
				"GroupAttributeEntityDao.remove - 'entities' cannot be null");
		}
		for (com.soffid.iam.iga.model.GroupAttributeEntity entity: entities) { 
			remove(entity);
		}
	...
	public void remove (java.lang.Long id)
	{
		...
		{
			throw new IllegalArgumentException(
				"GroupAttributeEntityDao.remove - 'id' can not be null");
		}
		com.soffid.iam.iga.model.GroupAttributeEntity entity = this.load(id);
		if (entity != null)
			this.remove(entity);
	}
	 ...
	 */
	public java.util.List<com.soffid.iam.iga.model.GroupAttributeEntity> query (String queryString, com.soffid.iam.model.Parameter[] parameters)
	{
		try {
	 ...
	 */
	public java.util.List<com.soffid.iam.iga.model.GroupAttributeEntity> query (String queryString, com.soffid.iam.model.Parameter[] parameters, com.soffid.iam.model.criteria.CriteriaSearchConfiguration criteria)
	{
		try {
			java.util.List results = new com.soffid.iam.model.QueryBuilder().query(this,
