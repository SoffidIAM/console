...
/**
 * DAO Base for Entity MailDomainEntity
 */
public abstract class MailDomainEntityDaoBase
	extends org.springframework.orm.hibernate3.support.HibernateDaoSupport
	implements com.soffid.iam.iga.model.MailDomainEntityDao
{
	...
	**/
	...
	{
		return findByCode("from com.soffid.iam.iga.model.MailDomainEntity where tenant.id=:tenantId and name=:name",
			criteria, name);
	}
	/**
	 * Internal implementation
	 */
	public com.soffid.iam.iga.model.MailDomainEntity findByCode(final java.lang.String queryString, com.soffid.iam.model.criteria.CriteriaSearchConfiguration criteria, java.lang.String name)
	
	{
		try
		{
			...
			com.soffid.iam.iga.model.MailDomainEntity result = null;
			if (results.size() > 1) {
				throw new org.springframework.dao.InvalidDataAccessResourceUsageException(
					"More than one instance of 'com.soffid.iam.iga.model.MailDomainEntity' was found when executing query --> '" + queryString + "'");
			}
			else if (results.size() == 1)
			{
				result = (com.soffid.iam.iga.model.MailDomainEntity) results.iterator().next();
			}
			return result;
		}
	...
	public com.soffid.iam.iga.api.MailDomain toMailDomain(com.soffid.iam.iga.model.MailDomainEntity entity) {
		final com.soffid.iam.iga.api.MailDomain target = new com.soffid.iam.iga.api.MailDomain();
		this.toMailDomain(entity, target);
		return target;
	}
	 ...
	 */
	public java.util.List<com.soffid.iam.iga.api.MailDomain> toMailDomainList (java.util.Collection<com.soffid.iam.iga.model.MailDomainEntity> instances) {
		if (instances == null)
			return null;
		else {
			java.util.LinkedList<com.soffid.iam.iga.api.MailDomain> list =
				new java.util.LinkedList<com.soffid.iam.iga.api.MailDomain>();
			for (final com.soffid.iam.iga.model.MailDomainEntity instance: instances)
			{
				list.add( toMailDomain(instance));
			}
			return list;
		}
	}
	...
	public void mailDomainToEntity (com.soffid.iam.iga.api.MailDomain source, com.soffid.iam.iga.model.MailDomainEntity target, boolean copyIfNull) {
		// Attributes for MailDomainEntity
	...
	public com.soffid.iam.iga.model.MailDomainEntity mailDomainToEntity (com.soffid.iam.iga.api.MailDomain instance) {
		com.soffid.iam.iga.model.MailDomainEntity entity = null;
		if (instance.getId() != null) 
			entity = load(instance.getId());
		if (entity == null)
			entity = newMailDomainEntity();
		mailDomainToEntity(instance, entity, true);
		return entity;
	}
	...
	public java.util.List<com.soffid.iam.iga.model.MailDomainEntity>  mailDomainToEntityList (java.util.Collection<com.soffid.iam.iga.api.MailDomain> instances) 
	{
		if (instances == null)
			return null;
		java.util.LinkedList<com.soffid.iam.iga.model.MailDomainEntity> list =
			new java.util.LinkedList<com.soffid.iam.iga.model.MailDomainEntity>();
		for (com.soffid.iam.iga.api.MailDomain instance: instances)
		{
			list.add (mailDomainToEntity(instance));
		}
		return list;
	}
	...
	{
		return new com.soffid.iam.iga.model.MailDomainEntityImpl();
	}
	...
	public com.soffid.iam.iga.model.MailDomainEntity load(java.lang.Long id) {
		...
		com.soffid.iam.iga.model.MailDomainEntity result = (com.soffid.iam.iga.model.MailDomainEntity) this.getHibernateTemplate().get(com.soffid.iam.iga.model.MailDomainEntityImpl.class, id);
	...
	public java.util.List<com.soffid.iam.iga.model.MailDomainEntity> loadAll() {
		org.hibernate.Query queryObject = super.getSession(false).createQuery
			("from com.soffid.iam.iga.model.MailDomainEntity where tenant.id=:tenantId");
		queryObject.setParameter("tenantId", com.soffid.iam.utils.Security.getCurrentTenantId());
		return (java.util.List<com.soffid.iam.iga.model.MailDomainEntity> ) queryObject.list();
	};
	...
	public void create (com.soffid.iam.iga.model.MailDomainEntity entity)
	{
		if (entity == null)
		{
			throw new IllegalArgumentException(
				"MailDomainEntityDao.create - 'entity' can not be null");
		}
	...
	public void update (com.soffid.iam.iga.model.MailDomainEntity entity)
	{
		...
		{
			throw new IllegalArgumentException(
				"MailDomainEntityDao.update - 'entity' can not be null");
		}
		entity.setUpdatedOn(new java.util.Date());
		entity.setUpdatedBy(com.soffid.iam.utils.Security.getCurrentAccount());
	...
	public void remove (com.soffid.iam.iga.model.MailDomainEntity entity)
	{
		...
		{
			throw new IllegalArgumentException(
				"MailDomainEntityDao.remove - 'entity' can not be null");
		}
	...
	public void create (java.util.Collection<? extends com.soffid.iam.iga.model.MailDomainEntity> entities) {
		...
		{
			throw new IllegalArgumentException(
				"MailDomainEntityDao.create - 'entities' cannot be null");
		}
		for (com.soffid.iam.iga.model.MailDomainEntity entity: entities) { 
			create(entity);
		}
	}
	...
	public void update (java.util.Collection<? extends com.soffid.iam.iga.model.MailDomainEntity> entities) {
		...
		{
			throw new IllegalArgumentException(
				"MailDomainEntityDao.update - 'entities' cannot be null");
		}
		for (com.soffid.iam.iga.model.MailDomainEntity entity: entities) { 
			update(entity);
		}
	...
	public void remove (java.util.Collection<? extends com.soffid.iam.iga.model.MailDomainEntity> entities) {
		...
		{
			throw new IllegalArgumentException(
				"MailDomainEntityDao.remove - 'entities' cannot be null");
		}
		for (com.soffid.iam.iga.model.MailDomainEntity entity: entities) { 
			remove(entity);
		}
	...
	public void remove (java.lang.Long id)
	{
		...
		{
			throw new IllegalArgumentException(
				"MailDomainEntityDao.remove - 'id' can not be null");
		}
		com.soffid.iam.iga.model.MailDomainEntity entity = this.load(id);
		if (entity != null)
			this.remove(entity);
	}
	 ...
	 */
	public java.util.List<com.soffid.iam.iga.model.MailDomainEntity> query (String queryString, com.soffid.iam.model.Parameter[] parameters)
	{
		try {
			java.util.List results = new com.soffid.iam.model.QueryBuilder().query(this,
				queryString, parameters);
			return (java.util.List<com.soffid.iam.iga.model.MailDomainEntity>) results;
		} catch (org.hibernate.HibernateException ex) {
			throw super.convertHibernateAccessException(ex);
		}
	}
	 ...
	 */
	public java.util.List<com.soffid.iam.iga.model.MailDomainEntity> query (String queryString, com.soffid.iam.model.Parameter[] parameters, com.soffid.iam.model.criteria.CriteriaSearchConfiguration criteria)
	{
		try {
			java.util.List results = new com.soffid.iam.model.QueryBuilder().query(this,
