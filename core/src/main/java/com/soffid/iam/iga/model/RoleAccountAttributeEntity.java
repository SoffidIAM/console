...
/**
 *  Entity RoleAccountAttributeEntity
 */

public abstract class RoleAccountAttributeEntity {
	 ...
	 * Attribute grant
	 */
	private com.soffid.iam.iga.model.RoleAccountEntity grant;
	/**
	 * Gets value for attribute grant
	 */
	public com.soffid.iam.iga.model.RoleAccountEntity getGrant() {
		return this.grant;
	}
	/**
	 * Sets value for attribute grant
	 */
	public void setGrant(com.soffid.iam.iga.model.RoleAccountEntity grant) {
		this.grant = grant;
	}
	/**
	 * Attribute metadata
	...
	**/
	...
	/**
	 * Returns <code>true</code> if the argument is an RoleAccountAttributeEntity instance and all identifiers for this entity 
	...
	public boolean equals(Object object)
	{
		...
		if (!(object instanceof RoleAccountAttributeEntity))
		{
			return false;
		}
		final RoleAccountAttributeEntity that = (RoleAccountAttributeEntity)object;
