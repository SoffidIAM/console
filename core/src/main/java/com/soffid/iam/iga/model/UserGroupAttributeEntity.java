...
public abstract class UserGroupAttributeEntity {
	 ...
	 * Attribute userGroup
	 */
	private com.soffid.iam.iga.model.UserGroupEntity userGroup;
	/**
	 * Gets value for attribute userGroup
	 */
	public com.soffid.iam.iga.model.UserGroupEntity getUserGroup() {
		return this.userGroup;
	}
	/**
	 * Sets value for attribute userGroup
	 */
	public void setUserGroup(com.soffid.iam.iga.model.UserGroupEntity userGroup) {
	...
	**/
	...
	/**
	 * Returns <code>true</code> if the argument is an UserGroupAttributeEntity instance and all identifiers for this entity 
	...
	public boolean equals(Object object)
	{
		...
		if (!(object instanceof UserGroupAttributeEntity))
		{
			return false;
		}
		final UserGroupAttributeEntity that = (UserGroupAttributeEntity)object;
