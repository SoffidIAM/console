...
/**
 * @see <code>com.soffid.iam.impl.service.ApplicationBootService</code>,
 * @see <code>com.soffid.iam.impl.service.ApplicationBootService</code>,
 */
@jakarta.ejb.Stateless(name="ApplicationBootService", mappedName="openejb:/local/soffid.ejb.com.soffid.iam.impl.service.ApplicationBootService")
@jakarta.ejb.Local(com.soffid.iam.impl.service.ejb.ApplicationBootService.class)
...
public class ApplicationBootServiceBean extends org.springframework.ejb.support.AbstractStatelessSessionBean
  implements com.soffid.iam.impl.service.ejb.ApplicationBootService
{
	...
	protected void onEjbCreate()
	{
		...
		this.applicationBootService = (com.soffid.iam.impl.service.ApplicationBootService)
		getBeanFactory().getBean("com.soffid.iam.impl.service.ApplicationBootService");
	}
