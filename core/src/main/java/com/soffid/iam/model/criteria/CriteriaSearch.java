...
{
	private com.soffid.iam.model.criteria.CriteriaSearchConfiguration configuration;
	...
	{
		this.configuration = new com.soffid.iam.model.criteria.CriteriaSearchConfiguration();
	 ...
	 */
	public com.soffid.iam.model.criteria.CriteriaSearchConfiguration getConfiguration()
	{
