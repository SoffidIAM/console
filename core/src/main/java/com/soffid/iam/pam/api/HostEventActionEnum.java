 ...
 * 
 */
public final class HostEventActionEnum
	extends HostEventAction
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((HostEventAction)object).getValue());
	}
	...
	{
		return HostEventAction.fromString(java.lang.String.valueOf(string));
	}
}
