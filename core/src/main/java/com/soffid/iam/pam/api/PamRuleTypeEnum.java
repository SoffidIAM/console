 ...
 * 
 */
public final class PamRuleTypeEnum
	extends PamRuleType
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((PamRuleType)object).getValue());
	}
	...
	{
		return PamRuleType.fromString(java.lang.String.valueOf(string));
	}
}
