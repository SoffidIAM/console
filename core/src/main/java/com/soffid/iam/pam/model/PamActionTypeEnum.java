 ...
 * 
 */
public final class PamActionTypeEnum
	extends PamActionType
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((PamActionType)object).getValue());
	}
	...
	{
		return PamActionType.fromString(java.lang.String.valueOf(string));
	}
}
