 ...
 * 
 */
public final class IssuePolicyStatusEnum
	extends IssuePolicyStatus
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return IssuePolicyStatus.class;
	}
	...
	{
		return java.lang.String.valueOf(((IssuePolicyStatus)object).getValue());
	}
	...
	{
		return IssuePolicyStatus.fromString(java.lang.String.valueOf(string));
	}
}
