 ...
 * 
 */
public final class RequestedObligationEnumEnum
	extends RequestedObligationEnum
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	 ...
	 */
	public RequestedObligationEnumEnum()
	{
		super();
	}
	...
	{
		return RequestedObligationEnum.class;
	}
	...
	{
		return java.lang.String.valueOf(((RequestedObligationEnum)object).getValue());
	}
	...
	{
		return RequestedObligationEnum.fromString(java.lang.String.valueOf(string));
	}
}
