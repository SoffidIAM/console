 ...
 * 
 */
public final class SoDRiskEnum
	extends SoDRisk
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((SoDRisk)object).getValue());
	}
	...
	{
		return SoDRisk.fromString(java.lang.String.valueOf(string));
	}
}
