 ...
 * 
 */
public final class SodRuleTypeEnum
	extends SodRuleType
			   ...
			   org.hibernate.usertype.EnhancedUserType
{
	...
	{
		return java.lang.String.valueOf(((SodRuleType)object).getValue());
	}
	...
	{
		return SodRuleType.fromString(java.lang.String.valueOf(string));
	}
}
