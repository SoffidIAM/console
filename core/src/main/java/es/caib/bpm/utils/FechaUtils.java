...
{
	/**
	 * Dada una fecha la transforma para que conincida con el comienzo del dia
	 * 
	...
	public static Date establecerFechaInicioDia (Date fechaResultado) throws Exception
	{
		...
		//establecemos el principio del dia
		...
		//retornamos la fecha de inicio del dia
		return calAuxiliar.getTime();
	}
	/**
	 * Dada una fecha la transforma para que conincida con el final del dia
	 * 
	 * @param fechaResultado
	 * @return
	 * @throws Exception
