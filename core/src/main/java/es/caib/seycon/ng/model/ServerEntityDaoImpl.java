...
public class ServerEntityDaoImpl
    extends es.caib.seycon.ng.model.ServerEntityDaoBase
{
    /**
    ...
    public void toServer(
        es.caib.seycon.ng.model.ServerEntity source,
        es.caib.seycon.ng.comu.Server target)
    {
     ...
     */
    public es.caib.seycon.ng.comu.Server toServer(final es.caib.seycon.ng.model.ServerEntity entity)
    {
        // @todo verify behavior of toServer
     ...
     */
    public void serverToEntity(
        es.caib.seycon.ng.comu.Server source,
        es.caib.seycon.ng.model.ServerEntity target,
        boolean copyIfNull)
    {
