...
public class Peticion  implements java.io.Serializable {
    private es.map.www.scsp.esquemas.V2.peticion.Atributos atributos;

    private es.map.www.scsp.esquemas.V2.peticion.Solicitudes solicitudes;

    public Peticion() {
    }

    public Peticion(
           es.map.www.scsp.esquemas.V2.peticion.Atributos atributos,
           es.map.www.scsp.esquemas.V2.peticion.Solicitudes solicitudes) {
     ...
     * @return atributos
     */
    public es.map.www.scsp.esquemas.V2.peticion.Atributos getAtributos() {
        return atributos;
    }
     ...
     * @param atributos
     */
    public void setAtributos(es.map.www.scsp.esquemas.V2.peticion.Atributos atributos) {
        this.atributos = atributos;
    }
     ...
     * @return solicitudes
     */
    public es.map.www.scsp.esquemas.V2.peticion.Solicitudes getSolicitudes() {
        return solicitudes;
    }
     ...
     * @param solicitudes
     */
    public void setSolicitudes(es.map.www.scsp.esquemas.V2.peticion.Solicitudes solicitudes) {
        this.solicitudes = solicitudes;
    }
