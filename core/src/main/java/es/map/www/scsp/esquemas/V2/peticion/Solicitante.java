...
public class Solicitante  implements java.io.Serializable {
    ...
    private es.map.www.scsp.esquemas.V2.peticion.Consentimiento consentimiento;

    private es.map.www.scsp.esquemas.V2.peticion.Funcionario funcionario;
    ...
    public Solicitante(
           ...
           es.map.www.scsp.esquemas.V2.peticion.Consentimiento consentimiento,
           es.map.www.scsp.esquemas.V2.peticion.Funcionario funcionario) {
     ...
     */
    public es.map.www.scsp.esquemas.V2.peticion.Consentimiento getConsentimiento() {
        return consentimiento;
    }
     ...
     */
    public void setConsentimiento(es.map.www.scsp.esquemas.V2.peticion.Consentimiento consentimiento) {
        this.consentimiento = consentimiento;
    }
     ...
     * @return funcionario
     */
    public es.map.www.scsp.esquemas.V2.peticion.Funcionario getFuncionario() {
        return funcionario;
    }
     ...
     * @param funcionario
     */
    public void setFuncionario(es.map.www.scsp.esquemas.V2.peticion.Funcionario funcionario) {
        this.funcionario = funcionario;
    }
