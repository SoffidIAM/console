...
public class Solicitudes  implements java.io.Serializable {
    private es.map.www.scsp.esquemas.V2.peticion.SolicitudTransmision[] solicitudTransmision;
     ...
     * @return solicitudes
     */
    public es.map.www.scsp.esquemas.V2.peticion.SolicitudTransmision[] getSolicitudTransmision() {
     ...
     * @param solicitudes
     */
    public void setSolicitudTransmision(es.map.www.scsp.esquemas.V2.peticion.SolicitudTransmision[] solicitudes) {
        this.solicitudTransmision = solicitudes;
    }
