...
public class Atributos  implements java.io.Serializable {
    ...
    private es.map.www.scsp.esquemas.V2.respuesta.Estado estado;
    ...
    public Atributos(
           ...
           es.map.www.scsp.esquemas.V2.respuesta.Estado estado,
     ...
     * @return estado
     */
    public es.map.www.scsp.esquemas.V2.respuesta.Estado getEstado() {
        return estado;
    }
     ...
     * @param estado
     */
    public void setEstado(es.map.www.scsp.esquemas.V2.respuesta.Estado estado) {
        this.estado = estado;
    }
