...
public class Consentimiento implements java.io.Serializable {
    ...
    public static final java.lang.String _Si = "Si"; //$NON-NLS-1$
    public static final java.lang.String _Ley = "Ley"; //$NON-NLS-1$
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/V2/respuesta", ">Consentimiento")); //$NON-NLS-1$ //$NON-NLS-2$
    }
    /**
