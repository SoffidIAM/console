...
public class Respuesta  implements java.io.Serializable {
    private es.map.www.scsp.esquemas.V2.respuesta.Atributos atributos;

    private es.map.www.scsp.esquemas.V2.respuesta.TransmisionDatos[] transmisiones;

    public Respuesta() {
    }

    public Respuesta(
           es.map.www.scsp.esquemas.V2.respuesta.Atributos atributos,
           es.map.www.scsp.esquemas.V2.respuesta.TransmisionDatos[] transmisiones) {
     ...
     * @return atributos
     */
    public es.map.www.scsp.esquemas.V2.respuesta.Atributos getAtributos() {
        return atributos;
    }
     ...
     * @param atributos
     */
    public void setAtributos(es.map.www.scsp.esquemas.V2.respuesta.Atributos atributos) {
        this.atributos = atributos;
    }
     ...
     */
    public es.map.www.scsp.esquemas.V2.respuesta.TransmisionDatos[] getTransmisiones() {
        return transmisiones;
    }
     ...
     * @param transmisiones
     */
    public void setTransmisiones(es.map.www.scsp.esquemas.V2.respuesta.TransmisionDatos[] transmisiones) {
        this.transmisiones = transmisiones;
    }
