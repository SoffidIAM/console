...
public class Atributos  implements java.io.Serializable {
    ...
    private es.map2.www.scsp.esquemas.V2.peticion.Estado estado;
    ...
    public Atributos(
           ...
           es.map2.www.scsp.esquemas.V2.peticion.Estado estado,
     ...
     * @return estado
     */
    public es.map2.www.scsp.esquemas.V2.peticion.Estado getEstado() {
        return estado;
    }
     ...
     * @param estado
     */
    public void setEstado(es.map2.www.scsp.esquemas.V2.peticion.Estado estado) {
        this.estado = estado;
    }
