...
public class Solicitante  implements java.io.Serializable {
    ...
    private es.map2.www.scsp.esquemas.V2.respuesta.Consentimiento consentimiento;

    private es.map2.www.scsp.esquemas.V2.respuesta.Funcionario funcionario;
    ...
    public Solicitante(
           ...
           es.map2.www.scsp.esquemas.V2.respuesta.Consentimiento consentimiento,
           es.map2.www.scsp.esquemas.V2.respuesta.Funcionario funcionario) {
     ...
     */
    public es.map2.www.scsp.esquemas.V2.respuesta.Consentimiento getConsentimiento() {
        return consentimiento;
    }
     ...
     */
    public void setConsentimiento(es.map2.www.scsp.esquemas.V2.respuesta.Consentimiento consentimiento) {
        this.consentimiento = consentimiento;
    }
     ...
     * @return funcionario
     */
    public es.map2.www.scsp.esquemas.V2.respuesta.Funcionario getFuncionario() {
        return funcionario;
    }
     ...
     * @param funcionario
     */
    public void setFuncionario(es.map2.www.scsp.esquemas.V2.respuesta.Funcionario funcionario) {
        this.funcionario = funcionario;
    }
