...
public class TransmisionDatos  implements java.io.Serializable {
    private es.map2.www.scsp.esquemas.V2.respuesta.DatosGenericos datosGenericos;
    ...
    public TransmisionDatos(
           es.map2.www.scsp.esquemas.V2.respuesta.DatosGenericos datosGenericos,
     ...
     */
    public es.map2.www.scsp.esquemas.V2.respuesta.DatosGenericos getDatosGenericos() {
        return datosGenericos;
    }
     ...
     */
    public void setDatosGenericos(es.map2.www.scsp.esquemas.V2.respuesta.DatosGenericos datosGenericos) {
        this.datosGenericos = datosGenericos;
    }
