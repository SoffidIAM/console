...
public class SolicitanteDatos  implements java.io.Serializable {
    private es.map2.www.scsp.esquemas.datosespecificos.Tipo tipo;
    ...
    private es.map2.www.scsp.esquemas.datosespecificos.Organizacion organizacion;

    public SolicitanteDatos() {
    }

    public SolicitanteDatos(
           es.map2.www.scsp.esquemas.datosespecificos.Tipo tipo,
           ...
           es.map2.www.scsp.esquemas.datosespecificos.Organizacion organizacion) {
           this.tipo = tipo;
           this.nombre = nombre;
     ...
     * @return tipo
     */
    public es.map2.www.scsp.esquemas.datosespecificos.Tipo getTipo() {
        return tipo;
    }
     ...
     * @param tipo
     */
    public void setTipo(es.map2.www.scsp.esquemas.datosespecificos.Tipo tipo) {
        this.tipo = tipo;
    }
     ...
     * @return organizacion
     */
    public es.map2.www.scsp.esquemas.datosespecificos.Organizacion getOrganizacion() {
        return organizacion;
    }
     ...
     * @param organizacion
     */
    public void setOrganizacion(es.map2.www.scsp.esquemas.datosespecificos.Organizacion organizacion) {
        this.organizacion = organizacion;
    }
    ...
    static {
        ...
        elemField.setFieldName("tipo"); //$NON-NLS-1$
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", "Tipo")); //$NON-NLS-1$ //$NON-NLS-2$
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.map.es/scsp/esquemas/datosespecificos", ">Tipo")); //$NON-NLS-1$ //$NON-NLS-2$
