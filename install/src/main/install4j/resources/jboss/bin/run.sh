...
### $Id: run.sh,v 1.1 2007-01-10 07:37:23 u07286 Exp $ ###

# JAVA_OPTS="-Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=1234 $JAVA_OPTS"

JAVA_OPTS="-XX:PermSize=64m -XX:MaxPermSize=500m -Xms256m -Xmx512m $JAVA_OPTS"
