...
public abstract class AccountMetadataEntity {
	...
	/********************** DAOS ************************/
	@DaoFinder("from com.soffid.iam.model.AccountMetadataEntity where system.codi = :system and name = :name")
	public AccountMetadataEntity findByName(String system,
			String name) {
		return null;
	}

	@DaoFinder("from com.soffid.iam.model.AccountMetadataEntity where system.codi = :systemName "
			+ "order by order")
