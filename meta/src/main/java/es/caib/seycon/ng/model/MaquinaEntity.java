...
public abstract class MaquinaEntity {
	...
	@Column (name="MAQ_NOM", length=50)
	public java.lang.String nom;

	@Column (name="MAQ_SISOPE", length=3)
	@Nullable
	public java.lang.String oldSistemaOperatiu;

	@Column (name="MAQ_ADRIP", length=25)
	@Nullable
	public java.lang.String adreca;

	@Column (name="MAQ_DESCRI", length=50)
	@Nullable
