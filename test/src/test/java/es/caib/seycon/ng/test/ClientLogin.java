...
public class ClientLogin {
		...
		for(int i=0;i<len;i++) {
		  ...
		  if (cb instanceof PasswordCallback) {
		    ...
		    throw new UnsupportedCallbackException
	            (cb, "Don't know what to do with this!!"); //$NON-NLS-1$
		  }
		}//end of for-loop
	  }
	}
	...
	private static final String WORKFLOW_DOMAIN= "bpm-domain"; //$NON-NLS-1$
	private static final String SEYCON_DOMAIN= "client-login"; //$NON-NLS-1$
}
