...
public class RoleApprovalProcessFieldHandler implements InputFieldUIHandler {

	@Override
	public void afterCreate(InputField3 field) throws Exception {
		List<String> l = new LinkedList<String>();
		for (ProcessDefinition def: EJBLocator.getBpmEngine().findProcessDefinitions (null, es.caib.bpm.vo.PredefinedProcessType.ROLE_GRANT_APPROVAL))
		{
			l.add(def.getName());
		}
		field.setValues(l);
