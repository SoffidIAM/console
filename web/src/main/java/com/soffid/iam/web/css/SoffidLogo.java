...
@WebServlet(name="soffid.logo", urlPatterns="/anonymous/logo-pb.svg")
public class SoffidLogo extends HttpServlet {
	byte[] getOriginalImage () throws IOException {
		InputStream in = getServletContext().getResourceAsStream("/img/anonymous/logo - pb.svg");
