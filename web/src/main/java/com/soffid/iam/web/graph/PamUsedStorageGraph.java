...
@WebServlet(urlPatterns="/graph/pam_storage_used")
public class PamUsedStorageGraph extends HttpServlet {
	...
	protected HashMap<String, Object> getStats()
	{
		try {
			...
			Stats stats = statsService.findStats("PAM_STORAGE_USED", c.getTime(), new Date(), 60*24);
			...
			for ( String serie: k)
			{
				...
				{
					datasetdata.add(value.getMax()/1024/1024);
				}
