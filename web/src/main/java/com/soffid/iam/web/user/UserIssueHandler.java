...
public class UserIssueHandler extends Div implements AfterCompose {
	private static final long serialVersionUID = 1L;
	private String listboxPath;

	public UserIssueHandler() throws NamingException, CreateException {
	}
	...
	public void openIssue(Event event) throws IOException {
		Long id = (Long) XPathUtils.eval(getListbox(), "id");
		Executions.getCurrent().sendRedirect("/issues/issues.zul?filter=id eq "+id, "_blank");
	}
