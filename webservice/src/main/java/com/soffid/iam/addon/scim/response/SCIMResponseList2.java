...
public class SCIMResponseList2 {
	...
	public SCIMResponseList2(Collection<Object> list) {
		this.resources = list;
	...
	public SCIMResponseList2(Collection<Object> list, PaginationUtil p) {
		if (p.isActive()) {
			this.resources = list;
	...
	public SCIMResponseList2(Collection<Object> list, PagedResult p) {
		this.resources = list;
		this.totalResults = p.getTotalResults();
		this.itemsPerPage = p.getItemsPerPage();
